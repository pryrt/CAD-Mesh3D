...
sub test_format {
    ...
    SKIP: {
        ...
        throws_ok { $CAD::Mesh3D::EnabledFormats{$format}{input}->() } $opt{input}, "Error Handling: EnabledFormats{$format}{input} error-test";
    }
    SKIP: {
...
test_format( 'MissingInput' => 'mockedFormat::MissingInput', input => qr/Input function for your format is not available/ );
...
test_format( 'MissingOutput' => 'mockedFormat::MissingOutput', output => qr/Output function for your format is not available/  );
